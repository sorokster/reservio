...
class CompanySerializer(serializers.ModelSerializer):
    class Meta:
        model = Company
        fields = ['id', 'name', 'description', 'website', 'email', 'created_at', 'updated_at']
...
class MenuItemSerializer(serializers.ModelSerializer):
    class Meta:
        model = MenuItem
        fields = ['id', 'name', 'description', 'price', 'cuisine', 'menu']
        read_only_fields = ['id']
...
class ReservationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'time_slots', 'time_slots_data', 'statuses', 'statuses_data',
            'created_at', 'updated_at'
        ]
